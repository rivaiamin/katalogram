...
var host=window.location.hostname;"www.katalogram.com"==host&&(host="katalogram.com"),"katalogram.dev"==host?(fbid="1506049499709287",googleid="13356134084-uo1b2bi0sn6vhvdslphhem7desofd5rt.apps.googleusercontent.com"):"katalogram.com"==host&&(fbid="1496399374007633",googleid="13356134084-uo1b2bi0sn6vhvdslphhem7desofd5rt.apps.googleusercontent.com");var kgApp=angular.module("kgApp",["ui.router","ngSanitize","satellizer","ngTouch","superswipe","angulartics","angulartics.google.analytics","ui-notification"]);kgApp.constant("kgConfig",{site:"//"+host+"/",api:"//api."+host+"/",files:"//files."+host+"/",embedly:"8081dea79e164014bcd7cd7e1ab2363a",fb:fbid,google:googleid}).config(["$httpProvider","$authProvider","$locationProvider","kgConfig",function(e,t,o,a){t.loginUrl=a.api+"auth/login",t.signupUrl=a.api+"auth/register",t.facebook({clientId:a.fb,url:a.api+"auth/facebook"}),t.google({clientId:a.google,url:a.api+"auth/google"})}]).controller("kgLandingCtrl",["$scope","$rootScope","$http","$state","$auth","$sce","$location","$interval","Notification","kgConfig",function(e,t,o,a,s,i,n,c,r,l){t.api=l.api,t.files=l.files,e.authenticate=function(e){s.authenticate(e).then(function(e){"success"==e.status&&($("#callAct").modal("hide"),$("#shareAct").modal("show")),r({message:e.data.message},e.data.status)})["catch"](function(e){r({message:e.data.message},"error")})},e.subscribe=function(t){e.isAction=!0,o.post(l.api+"auth/subscribe",{email:t}).success(function(t){"success"==t.status&&($("#callAct").modal("hide"),$("#shareAct").modal("show")),e.isAction=!1,r({message:t.message},t.status)})},e.shareTo=function(e){var t=window.location.href;if("facebook"==e)var o="https://www.facebook.com/sharer.php?u="+t;else if("twitter"==e)var o="https://twitter.com/home?status="+t;else if("google"==e)var o="https://plus.google.com/share?url="+t;return window.open(o,"shareCatalog","left=20,top=20,width=500,height=500,toolbar=1,resizable=0"),!1}}]),$(document).ready(function(){$(window).scroll(function(){$(window).scrollTop()+$(window).height()>$(document).height()-100&&$("#callAct").modal("show")}),$(".menu .item").tab(),$("#callAct").modal("attach events","#callActBtn","show"),$("#morphext1").Morphext({animation:"flipInY",separator:",",speed:8e3}),$("#morphext2").Morphext({animation:"flipInY",separator:",",speed:2e3})});var _smartsupp=_smartsupp||{};_smartsupp.key="cc1fd97b1ddc57f93720906a8da2de07d915ce03",window.smartsupp||function(e){var t,o,a=smartsupp=function(){a._.push(arguments)};a._=[],t=e.getElementsByTagName("script")[0],o=e.createElement("script"),o.type="text/javascript",o.charset="utf-8",o.async=!0,o.src="//www.smartsuppchat.com/loader.js?",t.parentNode.insertBefore(o,t)}(document),function(e,t,o){var a,s=e.getElementsByTagName(t)[0];e.getElementById(o)||(a=e.createElement(t),a.id=o,a.src="//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=1496399374007633",s.parentNode.insertBefore(a,s))}(document,"script","facebook-jssdk"),function(e,t,o,a,s,i,n){e.GoogleAnalyticsObject=s,e[s]=e[s]||function(){(e[s].q=e[s].q||[]).push(arguments)},e[s].l=1*new Date,i=t.createElement(o),n=t.getElementsByTagName(o)[0],i.async=1,i.src=a,n.parentNode.insertBefore(i,n)}(window,document,"script","https://www.google-analytics.com/analytics.js","ga"),ga("create","UA-83303735-1","auto"),ga("send","pageview");
