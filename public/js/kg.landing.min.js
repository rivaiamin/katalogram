...
window.onload=function(){window.loading_screen.finish()};var host=window.location.hostname;"www.katalogram.com"==host&&(host="katalogram.com"),"katalogram.dev"==host?(fbid="1506049499709287",googleid="13356134084-uo1b2bi0sn6vhvdslphhem7desofd5rt.apps.googleusercontent.com"):"katalogram.com"==host&&(fbid="1496399374007633",googleid="13356134084-uo1b2bi0sn6vhvdslphhem7desofd5rt.apps.googleusercontent.com");var kgApp=angular.module("kgApp",["ui.router","ngSanitize","satellizer","ngTouch","superswipe","angulartics","angulartics.google.analytics","ui-notification"]);kgApp.constant("kgConfig",{site:"//"+host+"/",api:"//api."+host+"/",files:"//files."+host+"/",embedly:"8081dea79e164014bcd7cd7e1ab2363a",fb:fbid,google:googleid}).config(["$httpProvider","$authProvider","$locationProvider","kgConfig",function(t,e,a,o){e.loginUrl=o.api+"auth/login",e.signupUrl=o.api+"auth/register",e.facebook({clientId:o.fb,url:o.api+"auth/facebook"}),e.google({clientId:o.google,url:o.api+"auth/google"})}]).controller("kgLandingCtrl",["$scope","$rootScope","$http","$state","$auth","$sce","$location","$interval","Notification","kgConfig",function(t,e,a,o,s,i,n,c,r,l){e.api=l.api,e.files=l.files,t.authenticate=function(t){s.authenticate(t).then(function(t){"success"==t.status&&$("#callAct").modal("hide"),r({message:t.data.message},t.data.status)})["catch"](function(t){r({message:t.data.message},"error")})},t.subscribe=function(e){t.isAction=!0,a.post(l.api+"auth/subscribe",{email:e}).success(function(e){"success"==e.status&&$("#callAct").modal("hide"),t.isAction=!1,r({message:e.message},e.status)})}}]),$(document).ready(function(){$(".ui.sidebar").sidebar("attach events",".toc.item"),$(".menu .item").tab(),$("#callAct").modal("attach events","#callActBtn","show")});var _smartsupp=_smartsupp||{};_smartsupp.key="cc1fd97b1ddc57f93720906a8da2de07d915ce03",window.smartsupp||function(t){var e,a,o=smartsupp=function(){o._.push(arguments)};o._=[],e=t.getElementsByTagName("script")[0],a=t.createElement("script"),a.type="text/javascript",a.charset="utf-8",a.async=!0,a.src="//www.smartsuppchat.com/loader.js?",e.parentNode.insertBefore(a,e)}(document),function(t,e,a){var o,s=t.getElementsByTagName(e)[0];t.getElementById(a)||(o=t.createElement(e),o.id=a,o.src="//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=1496399374007633",s.parentNode.insertBefore(o,s))}(document,"script","facebook-jssdk");
