...
window.onload=function(){window.loading_screen.finish()};var host=window.location.hostname;"www.katalogram.com"==host&&(host="katalogram.com"),"katalogram.dev"==host?(fbid="1506049499709287",googleid="13356134084-uo1b2bi0sn6vhvdslphhem7desofd5rt.apps.googleusercontent.com"):"katalogram.com"==host&&(fbid="1496399374007633",googleid="13356134084-uo1b2bi0sn6vhvdslphhem7desofd5rt.apps.googleusercontent.com");var kgApp=angular.module("kgApp",["ui.router","ngSanitize","satellizer","ngTouch","superswipe","angulartics","angulartics.google.analytics","ui-notification"]);kgApp.constant("kgConfig",{site:"//"+host+"/",api:"//api."+host+"/",files:"//files."+host+"/",embedly:"8081dea79e164014bcd7cd7e1ab2363a",fb:fbid,google:googleid}).config(["$httpProvider","$authProvider","$locationProvider","kgConfig",function(t,e,o,a){e.loginUrl=a.api+"auth/login",e.signupUrl=a.api+"auth/register",e.facebook({clientId:a.fb,url:a.api+"auth/facebook"}),e.google({clientId:a.google,url:a.api+"auth/google"})}]).controller("kgLandingCtrl",["$scope","$rootScope","$http","$state","$auth","$sce","$location","$interval","Notification","kgConfig",function(t,e,o,a,s,i,n,c,r,l){e.api=l.api,e.files=l.files,t.authenticate=function(t){s.authenticate(t).then(function(t){"success"==t.status&&($("#callAct").modal("hide"),$("#shareAct").modal("show")),r({message:t.data.message},t.data.status)})["catch"](function(t){r({message:t.data.message},"error")})},t.subscribe=function(e){t.isAction=!0,o.post(l.api+"auth/subscribe",{email:e}).success(function(e){"success"==e.status&&($("#callAct").modal("hide"),$("#shareAct").modal("show")),t.isAction=!1,r({message:e.message},e.status)})},t.shareTo=function(t){var e=window.location.href;if("facebook"==t)var o="https://www.facebook.com/sharer.php?u="+e;else if("twitter"==t)var o="https://twitter.com/home?status="+e;else if("google"==t)var o="https://plus.google.com/share?url="+e;return window.open(o,"shareCatalog","left=20,top=20,width=500,height=500,toolbar=1,resizable=0"),!1}}]),$(document).ready(function(){$(".ui.sidebar").sidebar("attach events",".toc.item"),$(".menu .item").tab(),$("#callAct").modal("attach events","#callActBtn","show")});var _smartsupp=_smartsupp||{};_smartsupp.key="cc1fd97b1ddc57f93720906a8da2de07d915ce03",window.smartsupp||function(t){var e,o,a=smartsupp=function(){a._.push(arguments)};a._=[],e=t.getElementsByTagName("script")[0],o=t.createElement("script"),o.type="text/javascript",o.charset="utf-8",o.async=!0,o.src="//www.smartsuppchat.com/loader.js?",e.parentNode.insertBefore(o,e)}(document),function(t,e,o){var a,s=t.getElementsByTagName(e)[0];t.getElementById(o)||(a=t.createElement(e),a.id=o,a.src="//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.8&appId=1496399374007633",s.parentNode.insertBefore(a,s))}(document,"script","facebook-jssdk");
