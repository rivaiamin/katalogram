...
var catalogCtrl=["$scope","$rootScope","$stateParams","$http","$state","$sce","$location","kgConfig",function(a,t,l,o,s,c,g,r){a.catalogs=[],a.scrollBusy=!1,a.limit=8,a.after=0,a.onSearch=!1,a.filter={},a.url=g.absUrl(),t.bgNav="",t.modalTemplate1="",t.$on("searchCatalog",function(){a.after=0,a.catalogs=[],a.filter.tags=t.filter.tags,a.catalogList()}),a.catalogList=function(){a.scrollBusy=!0,o.get(r.api+"catalog/"+a.after+"/"+a.limit,{params:{category:a.filter.category,tags:JSON.stringify(a.filter.tags)}}).success(function(t){for(var l=0;l<t.catalogs.length;l++)a.catalogs.push(t.catalogs[l]);t.catalogs.length>0&&(a.after=t.catalogs[t.catalogs.length-1].id,a.scrollBusy=!1)})}}];
